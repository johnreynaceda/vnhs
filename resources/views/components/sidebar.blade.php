<nav class="flex flex-1 flex-col">
            ...
            <ul role="list" class="-mx-2 space-y-1">
                ...
                <li>
                    <a href="{{ route('admin.document-requests') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-file-search">
                ...
                <li>
                    <a href="{{ route('dashboard') }}"
                        class="{{ request()->routeIs('dashboard') ? 'bg-gray-100 text-blue-700 font-semibold' : 'text-gray-600' }} group flex gap-x-2 rounded-md  p-2 text-sm/6   hover:text-blue-600 hover:bg-gray-50">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
    ...
    <li>
        <ul role="list" class="-mx-2 space-y-1">
            <li>
                <a href="#"
                    class="group flex gap-x-2 rounded-md  p-2 text-sm/6  text-gray-600 hover:text-blue-600 hover:bg-gray-50">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="lucide lucide-chart-column-increasing">
                        <path d="M13 17V9" />
                        <path d="M18 17V5" />
