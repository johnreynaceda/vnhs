<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex flex-col justify-center items-center border-x px-4">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-9 w-auto fill-current text-gray-800" />
                    </a>
                    <span class="text-xs font-bold text-blue-700">VNHS-SHS</span>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <a href="/chats" class="flex space-x-2 mr-5 item-center text-blue-600">
                ...
                <div x-data="{
                    ...
                    <button @click="dropdownOpen=true"
                        ...
                        <span class="flex flex-col items-start flex-shrink-0 h-full ml-2 leading-none translate-y-px">
                            ...
                            <span
                                class="text-xs font-light max-w-28 truncate text-neutral-400">{{ auth()->user()->email }}</span>
                        </span>
